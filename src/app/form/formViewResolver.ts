export class FormViewResolver{
    ...
    public LoadMetaData():Array<object>{
      ...
      public LoadCustomDropDown():Array<object>{
        let Values =  new Array<object>();
        Values.push(
       
        {code:'Customer',Name:'Customer',AttributeType:'lookup',PicklistId:1,IsMandatory:true, cssClass: "first-group",colCount: null,length:null,IsCustomValidation:false,validationCallback:null},
